    ...
    public static Pesoas adicionaralguem(Scanner s) {
        ...
        while (loop == 0) {
            ...
            if (loop > 3 || loop < 1) {
                ...
                if (loop == 1) {
                    pessoa.setSentimento(Sentimento.BEM);
                }
                if (loop == 2) {
                    pessoa.setSentimento(Sentimento.FELIZ);
                }
                if (loop == 3) {
                    pessoa.setSentimento(Sentimento.CANSADO);
                }
            }
        }
        return pessoa;
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (resposta > 0 || resposta < 8) {
                ...
                if (resposta == 3) {
                    System.out.println("Eu estou "+Instanciadas[0].getSentimento()+"!");
                }
                if (resposta == 4) {
                ...
                if (resposta == 6) {
                    System.out.println("Eu estou "+Instanciadas[1].getSentimento()+"!");
                }
                if (resposta == 7) {
                    System.exit(0);
                }
